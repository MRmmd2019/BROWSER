# 🧩 kingofshojo.com_20260527_195738
...
| ویژگی | مقدار |
|---|---|
| **لینک اصلی** | `https://kingofshojo.com/manga/a-golden-world-to-you/` |
| **دامنه** | `kingofshojo.com` |
| **زمان آرشیو** | 20260527_195738 (UTC) |
| **نوع خروجی** | `zip_and_folder` |
| **سطح فشرده‌سازی** | 9 از ۹ |
| **جهت PDF** | center |
| **محافظت با رمز** | ❌ خیر |
| **حجم کل ZIP** | 9.0M (1 بخش) |
| **چکسام SHA256** | `af11fe023e55e864229e859a736635125e979e991c8376efa2a520f493f22337` |
...
| # | فایل | لینک |
|---|---|---|
| 1 | `kingofshojo.com_20260527_195738.zip` | [⬇️ Download](https://github.com/MRmmd2019/BROWSER/raw/main/BROWSER/kingofshojo.com_20260527_195738.zip) |
...
```bash
# بررسی چکسام SHA256
sha256sum -c <<< 'af11fe023e55e864229e859a736635125e979e991c8376efa2a520f493f22337  kingofshojo.com_20260527_195738.zip'

# استخراج فایل
unzip kingofshojo.com_20260527_195738.zip
```
...
2. **استخراج:** در صورت استفاده از ZIP: `unzip kingofshojo.com_20260527_195738.zip`
