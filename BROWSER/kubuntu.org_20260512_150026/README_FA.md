...
| ویژگی | مقدار |
|---|---|
| **لینک اصلی** | `https://kubuntu.org/download/` |
| **دامنه** | `kubuntu.org` |
| **زمان آرشیو** | 20260512_150026 (UTC) |
| **نوع خروجی** | `zip_and_folder` |
| **سطح فشرده‌سازی** | 9 از ۹ |
| **جهت PDF** | rtl |
| **محافظت با رمز** | ❌ خیر |
| **حجم کل ZIP** | 3.9M (1 بخش) |
| **چکسام SHA256** | `c9b258fbb9aa27dc8ccb40f34ffb143bde1784cfdfa41c2444d497d825b07173` |
...
2. **استخراج:** در صورت استفاده از ZIP: `unzip kubuntu.org_20260512_150026.zip`
