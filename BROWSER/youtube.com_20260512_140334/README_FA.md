...
| ویژگی | مقدار |
|---|---|
| **لینک اصلی** | `https://www.youtube.com/watch?v=0EIXBqZ2m1c` |
| **دامنه** | `youtube.com` |
| **زمان آرشیو** | 20260512_140334 (UTC) |
| **نوع خروجی** | `zip_and_folder` |
| **سطح فشرده‌سازی** | 9 از ۹ |
| **جهت PDF** | rtl |
| **محافظت با رمز** | ❌ خیر |
| **حجم کل ZIP** | 18M (1 بخش) |
| **چکسام SHA256** | `3b064b2279a91f45aa6ee8e28cf6878b14e11be854f939594495a06181063f12` |
...
2. **استخراج:** در صورت استفاده از ZIP: `unzip youtube.com_20260512_140334.zip`
